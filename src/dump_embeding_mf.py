...
if __name__ == "__main__":
    user_embed_name = "uid_emb_matrix"  # 用户embedding的变量名字 The variable name of the user embedding
    data = get_variable(user_embed_name)
    user_embdeeing = "./data_resource/pickl_data/user_embdeeing_mf.data"
    dump_data(data, user_embdeeing)

    item_embed_name = "item_emb_matrix"  # 物品embedding的变量名字 The variable name of the item embedding
    data = get_variable(item_embed_name)
    item_embdeeing = "./data_resource/pickl_data/item_embdeeing_mf.data"
