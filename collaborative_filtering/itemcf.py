...
class ItemBasedCF(object):
    ...
    def calc_movie_sim(self):
        ...
        print(
            "calculate movie similarity matrix(similarity factor) succ", file=sys.stderr
        )
...
if __name__ == "__main__":
    ratingfile = os.path.join(
        "film_recommend/data_resource/origin_data/ml-1m", "ratings_test.dat"
    )
    itemcf = ItemBasedCF()
