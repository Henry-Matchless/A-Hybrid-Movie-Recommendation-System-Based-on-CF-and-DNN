...
file1_path = "data_resource/summary/dnn/Epoch2/dnn_" + str(epoch) + "_loss_eval" + ".csv"
file2_path = "data_resource/summary/ncf/Epoch2/ncf_" + str(epoch) + "_loss_eval" + ".csv"
file3_path = "data_resource/summary/mf/Epoch2/mf_" + str(epoch) + "_loss_eval"+ ".csv"
