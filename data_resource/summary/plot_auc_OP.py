...
file1_path = "data_resource/summary/ncf/Epoch2_Adam_lr0.01/run_eval-tag-ncf_auc_eval.csv"
file2_path = "data_resource/summary/ncf/Epoch2_Adam_lr0.001/run_eval-tag-ncf_auc_eval.csv"
file3_path = "data_resource/summary/ncf/Epoch2_Adam_lr0.0001/run_eval-tag-ncf_auc_eval.csv"
file4_path = "data_resource/summary/ncf/Epoch2_Adam_lr0.1/run_eval-tag-ncf_auc_eval.csv"
...
plt.ylabel("AUC")  # y轴标签
plt.plot(x, y4, ls="-", lw=2, color="tab:purple", label="NMF with Adam lr=0.0001")
plt.plot(x, y1, ls="-", lw=2, color="tab:blue", label="NMF with Adam lr=0.01")
plt.plot(x, y2, ls="-", lw=2, color="tab:red", label="NMF with Adam lr=0.001")
plt.plot(x, y3, ls="-", lw=2, color="tab:green", label="NMF with Adam lr=0.0001")
